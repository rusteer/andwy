...
public class ReplaceU {
    public static void main(String[] args) {
        new ReplaceU().execute("E:/workspace/pay/code/projects/SiXiangMeiNv/V1/trunk");
    }
    
    public void execute(String sourceFolder) {
        batchReplaceU(sourceFolder);
    }
    private ScriptEngineManager manager = new ScriptEngineManager();
    private ScriptEngine engine = manager.getEngineByName("js");// ScriptEngine用来处理脚本解释和求值
